                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mb-2">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <div class="bg-grey p-2">
                                                    <h6 class="form-control-static mb-0">{{ $ticket->nomor_surat }}</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 mb-2">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <div class="bg-grey p-2">
                                                    <h6 class="form-control-static mb-0">{{ $ticket->pengirim }}</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 mb-2">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <div class="bg-grey p-2">
                                                    <h6 class="form-control-static mb-0">{{ $ticket->disposisi }}</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 mb-2">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <div class="bg-grey p-2">
                                                    <h6 class="form-control-static mb-0">{{ $ticket->tanggal_diterima }}
                                                    </h6>
                                                </div>
                                            </div>
                                        </div>
