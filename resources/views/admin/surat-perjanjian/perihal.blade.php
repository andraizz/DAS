...
<div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a class="text-muted text-decoration-none"
                                    href="./">Dashboard</a></li>
                            <li class="breadcrumb-item" aria-current="page">Surat Perjanjian - Perihal</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
    ...
    <div class="row align-items-center mx-4">
        <div class="col-lg-10">
            <h4 style="display: flex; align-items: center;">Surat Perjanjian - Perihal</h4>
        </div>
        <div class="col-lg-2">
            <a href="{{ route('admin.surat-perjanjian.form2') }}"
