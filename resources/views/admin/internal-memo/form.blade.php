                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a class="text-muted text-decoration-none"
                                        href="./">Dashboard</a></li>
                                <li class="breadcrumb-item"><a class="text-muted text-decoration-none"
                                        href="{{ route('admin.internal-memo.projek') }}">Internal Memo - Projek</a>
                                </li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="needs-validation" method="POST"
                                    action="{{ route('admin.internal-memo.store') }}" enctype="multipart/form-data"
                                    novalidate>
                                    @csrf
                                    <div class="mb-3 row">
                                        <!-- Input untuk Kode Projek -->
                                        <label for="kode_projek" class="col-md-2 col-form-label">Kode Projek</label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" id="kode_projek" name="kode_projek"
                                                placeholder="Masukkan kode projek (max 15 karakter)" maxlength="15"
                                                required>
